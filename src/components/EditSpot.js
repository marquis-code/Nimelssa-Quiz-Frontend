...
import {getOneSpotQuestion, updateSpotQuestion, getAllCategories} from '../apis/auth';
...
const EditSpot = () => {
    ...
    return (
        <>
        <Helmet><title>Nimelssa Quiz | Edit SPOT</title> </Helmet>
            ...
            <div className='lg:w-6/12 lg:order-last'>
                ...
                <form onSubmit={handleSubmit} className='rounded-lg shadow-sm p-3 md:p-10  lg:m-0' noValidate>
                            <div className='white flex flex-col'>
                                <h1 className='font-thin text-2xl font-serif select-none'>Edit Multiple Choice Questions(SPOT).</h1>
                            </div>
